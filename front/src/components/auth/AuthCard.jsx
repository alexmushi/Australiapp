  ...
  return (
    ...
    >
      <div
        className="
          w-full max-w-lg
          rounded-lg overflow-hidden shadow-lg relative z-10 bg-surface text-onSurface
        "
      >
        <div className="flex flex-col w-full h-full p-6 sm:p-8 md:p-10">
          ...
          <h1
            className="
              ...
              text-onSurface mb-2 font-serif
            "
          >
            {title}
          </h1>
          <p className="mb-4 text-onSurface/80 text-sm sm:text-base">{description}</p>
          {children}
        </div>
      </div>
    </div>
