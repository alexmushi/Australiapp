...
export default function Navbar({ onNavigate, onLogout, currency, onCurrencyChange }) {
  ...
  return (
    <nav className='bg-[#1e1e1e] text-gray-200 p-4 flex items-center gap-2'>
      <md-filled-tonal-button onClick={() => onNavigate('home')}>Inicio</md-filled-tonal-button>
      <md-filled-tonal-button onClick={() => onNavigate('reviewer')}>Revisores</md-filled-tonal-button>
      <md-filled-tonal-button onClick={() => onNavigate('category')}>Categorías</md-filled-tonal-button>
