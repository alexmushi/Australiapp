...
export default function Navbar({ onNavigate, onLogout, currency, onCurrencyChange }) {
  ...
  return (
    <nav className='bg-surface text-onSurface p-4 flex items-center gap-4'>
      <button
      ...
      <div className='relative'>
        ...
        {open && (
          <div className='absolute right-0 mt-2 w-40 bg-surface text-onSurface rounded shadow-md p-2'>
            <md-outlined-select
